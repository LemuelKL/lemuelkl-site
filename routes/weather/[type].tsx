...
export default function Page({ data }: PageProps<LocalWeatherData | null>) {
    ...
    return (
        <div
            class={tw`bg-coolGray-200 h-screen flex justify-center items-center bg-gradient-to-br from-yellow-50 via-blue-200 to-coolGray-300`}
        >
            <div
                class={tw`mx-auto max-w-screen-md bg-white rounded-xl p-6 flex flex-col items-center gap-8 shadow-2xl`}
            >
